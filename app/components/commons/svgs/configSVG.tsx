interface Props{
    customStyle:{
        ...
        width:string,
        height:string,
        stroke:string //#CCCCCC
    }
}
export const ConfigSVG = ({customStyle }:Props) => {
    return <svg
    className={`${customStyle.fill} ${customStyle.fillHover}`}
